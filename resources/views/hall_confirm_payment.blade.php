                        ...
                        <div class="container outer-div-inner">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-4 col-6">
                                    <h3>Issued By</h3>
                                    <p>ICMARD Building,<br> 6TH Floor,Block-14/2, <br>C.I.T. Scheme-VIII (M), Ultadanga,<br> Kolkata-700 067<br>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $alldates=json_decode($hall_book[0]->all_dates);
