...
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Rule {{ isset($customer)?'Edit':'Add'}}</h4>
                    ...
                    <form class="forms-sample" method="post" action="{{ isset($customer)?route('admin.ruleseditconfirm'):route('admin.rulesadd')}}"> 
                        @csrf
                        ...
                        <div class="form-group">
                            <label for="exampleInputName1">Rules </label>
                            <input type="text" class="form-control" required name="rules"  id="rules" value="{{isset($customer)?$customer->rules:''}}" placeholder="Rules">
                        </div>
