                        ...
                        <div class="card-body">
                            ...
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="col-lg-3 pl-0">
                                    <p class="mt-5 mb-2">
                                        <b>{{$guest_details[0]->first_name." ".$guest_details[0]->middle_name." ".$guest_details[0]->last_name}}</b>
                                    </p>
                            ...
                            <div class="container-fluid d-flex justify-content-between">
                                <div class="col-lg-5 pl-0">
                                    <p class="mb-0 mt-5">Booking Date :
                                        {{ date('d-m-Y H:i:s',strtotime($datas[0]->booking_time))}}</p>
                                    ...
                                    <table class="table mt-3">
                                        ...
                                        <tbody>
                                            <tr class="text-right">
                                                ...
                                                <td class="text-left">
                                                    <?php 
                                                        $ddd=json_decode($datas[0]->all_dates,true);
                                                        $i=1;
                                    ...
                                    <table class="table mt-3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="text-right">
                                                ...
                                                <td class="text-left">
                                                    <?php if($guest_detail->child_flag=='Y'){echo "Child";}else{echo "Adult";} ?>
                                                </td>
